...
export type AudioCaptureSource =
  | 'agent' // Only capture agent's audio output
  | 'user' // Only capture user's microphone input
  | 'both'; // Capture both agent and user audio
 ...
 */
export type AudioCaptureCallback = (
